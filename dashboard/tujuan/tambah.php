...
<div class="wrapper">
    <div class="card">
        ...
        <div class="card__body">
            <form class="form" action="/moka-native/backend/tujuan/tambah-tujuan.php" method="post">
                <div class="form-control">
                    <label for="name" class="label">Nama</label>
                    <input id="name" name="nama_tujuan" type="text" class="input" />
                </div>
                <div class="form-control">
                ...
                <div class="form-control">
                    ...
                    <input id="jumlah" name="jumlah_tujuan" type="text" class="input" />
                </div>
