...
<div class="wrapper">
    <div class="card">
        ...
        <div class="card__body">
            <form class="form" action="/moka-native/backend/anggaran/tambah-anggaran.php" method="post">
                <div class="form-control">
                    <label for="name" class="label">Nama</label>
                    <input id="name" name="nama_anggaran" type="text" class="input" required />
                </div>
                <div class="form-control">
                ...
                <div class="form-control">
                    ...
                    <input id="jumlah" name="jumlah_anggaran" type="number" class="input" required />
                </div>
