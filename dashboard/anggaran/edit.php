...
<div class="wrapper">
    <div class="card">
        ...
        <div class="card__body">
            <form class="form" action="/moka-native/backend/anggaran/edit-anggaran.php?id=<?= $anggaran["id_anggaran"] ?>" method="post">
                <div class="form-control">
                    <label for="name" class="label">Nama</label>
                    <input id="name" name="nama_anggaran" type="text" class="input" value="<?= $anggaran["nama_anggaran"] ?>" required/>
                </div>
                <div class="form-control">
                    <label for="keterangan" class="label">Keterangan</label>
                    <input id="keterangan" name="keterangan" type="text" class="input" value="<?= $anggaran["keterangan"] ?>"/>
                </div>
                <div class="form-control">
                    <label for="jumlah" class="label">Jumlah</label>
                    <input id="jumlah" name="jumlah_anggaran" type="number" class="input" value="<?= $anggaran["jumlah_anggaran"] ?>" required />
                </div>
